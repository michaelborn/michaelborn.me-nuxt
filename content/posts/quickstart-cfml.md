...
This is a fantastic resource for new CFML devs, and covers the gamut from CF's underlying architecture (Java, compilation vs. interpretation, etc.) to the basic [syntax	](https://modern-cfml.ortusbooks.com/cfml-language/syntax), [data](https://modern-cfml.ortusbooks.com/cfml-language/arrays) [structures](https://modern-cfml.ortusbooks.com/cfml-language/structures), and [concepts](https://modern-cfml.ortusbooks.com/cfml-language/null-and-nothingness) of the language.

https://modern-cfml.ortusbooks.com

### LearnCFInAWeek

I did my share of reading on this website when I was first learning CFML, and I still use it for some topics now and then. While these tutorials are a little aged, they are helpful in that they focus on specific topics such as [XSS protection](http://www.learncfinaweek.com/week1/Cross_Site_Scripting__XSS_/), [Caching](http://www.learncfinaweek.com/week1/Caching/) and [OOP](http://www.learncfinaweek.com/week1/OOP/).
...
Sometimes you don't know what you don't know. Listening to a good podcast will bring you in contact with other ideas, tools and programming techniques that _you didn't know you didn't know_.

### Modernize Or Die Podcast

Ortus is tackling the CFML podcast space with their Modernize Or Die podcasts, and they're doing an awesome job of it. For news and tips, check out the [CFML News edition](https://cfmlnews.modernizeordie.io). The VS Code tips are especially useful for beginners. The [Soapbox edition](https://soapbox.modernizeordie.io) is great for wider discussion-type stuff, and may help you keep your overall goals and focus tuned for success.
